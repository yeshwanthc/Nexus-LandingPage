  ...
  return (
    <section className="pt-32 pb-16 px-4">
      <div className="max-w-7xl mx-auto text-center">
        ...
        >
          <div className={`bg-gradient-to-r from-purple-500/20 to-blue-500/20 rounded-full px-4 py-1 text-sm font-medium text-purple-200 inline-flex items-center gap-2 transition-transform duration-300 ${isHovered ? 'scale-110' : ''}`}>
        ...
        <p className="text-xl text-gray-400 max-w-2xl mx-auto mb-12 transform transition-all duration-500 hover:scale-105">
